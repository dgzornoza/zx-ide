...
const messages = {
  en: {
    ...
    "create-sprites": {
      ...
      sectionSprites: "Sprites",
      spritesHint:
        'Click "Add frame" on a sprite card to mark it active, then enter a binary matrix above and click "Add" to fill that sprite. Use "Add sprite" to start a new sprite.',
      spriteNameLabel: "Name",
      spriteWidthLabel: "Width (px)",
      spriteHeightLabel: "Height (px)",
      frameLabel: "Frame",
