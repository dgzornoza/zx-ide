...
export class InversifyConfig {
  ...
  public static initialize(extensionContext: vsc.ExtensionContext): void {
    ...
    InversifyConfig._container
      .bind<AttachProjectTilesCmd>(Types.AttachProjectTilesCmd)
      .to(AttachProjectTilesCmd)
      .inSingletonScope()
      .onActivation(InversifyConfig._subscribe);
    ...
    InversifyConfig._container
      .bind<Z88dkAsmBreakpointService>(Types.Z88dkBreakpointService)
      .to(Z88dkAsmBreakpointService)
      .inSingletonScope()
      .onActivation(InversifyConfig._subscribe);
